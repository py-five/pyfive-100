...
set ::env(LIB_SYNTH)  $::env(DESIGN_DIR)/lib/trimmed.lib
...
set ::env(TMP_DIR) "./tmp/"
set ::env(yosys_report_file_tag) "./reports/synthesis/yosys"
set ::env(yosys_result_file_tag) "./reports/synthesis/yosys.synthesis"
