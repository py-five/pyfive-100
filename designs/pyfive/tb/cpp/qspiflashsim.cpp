...
//
//
// Operation      Command    One Byte Command Code  Description     Address Byte Cy-cle  Mode Bit Cycle   Dummy Byte Cycle   Data Byte Cycle
// Read             READ     (03h) 0000 0011        Read Data bytes    3                    0                0                  1 to infinity
// Read          FAST_READ   (0Bh) 0000 1011        Read Data bytes 
//                                                  at Fast Speed      3                    0                1                  1 to inifinity
// Read             DOR      (3Bh) 0011 1011        Dual Output Read   3                    0                1                  1 to infinity
// Read             QOR      (6Bh) 0110 1011        Quad Output Read   3                    0                1                  1 to infinity 
//                 DIOR      (BBh) 1011 1011        Dual I/O High 
//                                                  Performance Read   3                    1                0                  1 to infinity 
//                 QIOR      (EBh) 1110 1011        Quad I/O High 
//                                                  Performance Read   3                    1                2                  1 to infinity
//                 RDID      (9Fh) 1001 1111        Read 
//                                                  Identification     0                    0                0                  1 to 81
//                 READ_ID   (90h) 1001 0000        Read Manufacturer 
//                                                  and Device 
//                                                  Identification     3                    0                0                  1 to infinity
// Write Control   WREN      (06h) 0000 0110        Write Enable       0                    0                0                  0
//                 WRDI      (04h) 0000 0100        Write Disable      0                    0                0                  0
// Erase           P4E       (20h) 0010 0000        4-KB Parameter 
//                                                  Sector Erase       3                    0                0                  0
//                 P8E       (40h) 0100 0000        8-KB (two 4KB) 
//                                                  Parameter Sector 
//                                                  Erase              3                    0                0                  0
//                 SE        (D8h) 1101 1000        64-KB Sector 
//                                                  Erase              3                    0                0                  0
//                 BE        (60h) 0110 0000 or 
//                           (C7h) 1100 0111        Bulk Erase         0                    0                0                  0
// Program         PP        (02h) 0000 0010        Page Programming   3                    0                0                  1 to 256
//                 QPP       (32h) 0011 0010        Quad Page 
//                                                  Programming        3                    0                0                  1 to 256
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include <stdio.h>
#include <string.h>
...
void	QSPIFLASHSIM::load(const unsigned addr, const char *fname) {
	...
	if (addr >= m_membytes)
	 ...
	 // Variables
         ...
         __Vtemp1[1U] = 0x656c6c6fU;
         __Vtemp1[2U] = 0x68U;
         VL_READMEM_N(true, 8, m_membytes, 0, VL_CVT_PACK_STR_NW(3, __Vtemp1) , m_mem , 0, ~0ULL);

	 for(unsigned i=0x200; i < 0x210; i++)
	     printf("QSPI: mem = %04x Data =: %0x\n", i,m_mem[i]);
...
int	QSPIFLASHSIM::operator()(const int csn, const int sck, const int dat) {
	...
	if (m_quad_mode) {
		printf("SFLASH-QUARD, ireg=%x -> data:%x -> mcount: %d\n", m_ireg, dat,m_count);
		m_ireg = (m_ireg << 4) | (dat & 0x0f);
		m_count+=4;
		m_oreg <<= 4;
	} else {
		printf("SFLASH-NORMAL, ireg=%x -> data:%x -> mcount: %d\n", m_ireg, dat,m_count);
